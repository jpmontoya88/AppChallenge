...
struct Constants {
    ...
    struct Api {
        ...
        static let topratedurl = String("https://api.themoviedb.org/3/tv/top_rated?api_key=91b79e1c018c1a145c60282db74f86e7&language=en-US&page=1")
        static let ontvurl = String("https://api.themoviedb.org/3/tv/on_the_air?api_key=91b79e1c018c1a145c60282db74f86e7&language=en-US&page=1")
        static let airingurl = String("https://api.themoviedb.org/3/tv/airing_today?api_key=91b79e1c018c1a145c60282db74f86e7&language=en-US&page=1")
